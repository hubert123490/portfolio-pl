  ...
  <div>
    ...
    <Divider speed={0.1} offset={offset} factor={factor}>
      <UpDown>
        ...
        <Svg icon="star" width={8} stroke color="icon_darkest" left="25%" top="5%" />
        <Svg icon="star" hiddenMobile width={24} color="icon_orange" left="80%" top="80%" />
      </UpDown>
      <UpDownWide>
        <Svg icon="star" hiddenMobile width={16} color="icon_purple" left="5%" top="80%" />
        <Svg icon="star" width={12} stroke color="icon_brightest" left="95%" top="50%" />
        <Svg icon="star" hiddenMobile width={6} color="icon_brightest" left="85%" top="15%" />
      ...
      <Svg icon="star" width={12} color="icon_darkest" left="70%" top="60%" />
      <Svg icon="star" width={6} color="icon_orange" left="10%" top="10%" />
      <Svg icon="star" width={12} color="icon_darkest" left="20%" top="30%" />
      <Svg icon="star" width={8} stroke color="icon_darkest" left="80%" top="70%" />
    </Divider>
