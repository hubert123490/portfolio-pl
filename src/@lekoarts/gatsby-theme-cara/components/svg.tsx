...
const icons = {
  ...
  star: {
    shape: (
      <path d="m 7.8125 10.9375 L 9.375 7.8125 L 10.9375 10.9375 L 14.0625 12.5 L 10.9375 14.0625 L 9.375 17.1875 L 7.8125 14.0625 L 4.6875 12.5 L 7.8205 10.9384"/>
    ),
    viewBox: `0 0 30 20`
  },
}

type IconType = "triangle" | "circle" | "arrowUp" | "upDown" | "box" | "hexa" | "cross" | "star" | "face"
